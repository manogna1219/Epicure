...
String cost=request.getParameter("c");
...
<div class="body"></div>
	 ...
	 <input type="fix" placeholder="Hotel" name="h" value="<%=hotel%>" readonly><br>
      <input type="fix" placeholder="Dish" name="d" value="<%=dish%>" readonly><br>
      <input type="fix" placeholder="Cost" name="c" value="<%=cost%>" readonly><br>
